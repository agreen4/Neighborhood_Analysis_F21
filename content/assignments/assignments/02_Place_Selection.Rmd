...
linktitle: Place Selection Memorandum
menu:
  assignments:
    parent: Assignments
    weight: 2
...
**Due Date:** September 10, 2021 | **Submit Via:** Upload to Github
...
- Many of the techniques you will learn use methods that draw on data available at the census tract level, as census tracts are frequently used as (imperfect) proxies for neighborhoods. A city county may be appropriate place geographies to focus on. 
...
Islands and territories (such as Puerto Rico and Hawaii) and remote areas (such as Alaska) are interesting, but geography and data availability can make them challenging places to analyze. Students have analyzed all of these places in recent years- but with great difficulty and extra effort needed to address data gaps and limitations. You may want to explore these issues before committing to one of these places.
