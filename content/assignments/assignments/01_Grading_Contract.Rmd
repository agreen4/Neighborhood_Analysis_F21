...
{{% callout warning %}}
Please use the following [contract template](/syllabus/documents/UP494 F21 Learning Contract.docx) to construct your proposed learning contract for the semester. 
{{% /callout %}}
