...
You will independently apply the skills and principles of data analysis we learn  to produce a policy-relevant analysis. You should be drawing heavily from the prior memorandums which you have produced over the course of the semester. You may include new or more refined work, but most of the pieces should already exist within your previous work. Your goal should be to combine elements of this previous work into a publication ready policy report for your place. At a minimum, you should plan to structure your report to address the following:
