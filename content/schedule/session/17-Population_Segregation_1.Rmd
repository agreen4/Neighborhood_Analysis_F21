---
linktitle: "17 Segregation (Part 1)"
menu:
  session:
    parent: Course Sessions
    weight: 17
title: 'Session 17: Population Distribution and Segregation (Part 1)'
toc: true
type: docs
weight: 17
---
...
Please [download the lab files](/schedule/session/17-Population_Segregation_1_files/19_Segregation.zip). We will be working in the same lab notebook on Thursday.
