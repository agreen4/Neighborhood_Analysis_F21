...
Prepare a new lab notebook that loads the neighborhood indicator data we have worked with for the past several weeks.
...
1. Indicator Selection - at the beginning of this lab, we will randomly select three variables from our neighborhood indicator dataset from which you will craft your story. You will not be able to use other indicators aside from those selected.
